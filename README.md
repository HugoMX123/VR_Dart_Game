...
A simple dart game created in Unity with two modes: **Practice Mode** and **AI Mode**.

## Features

- **Practice Mode**: Throw darts and track your score alone.
- **AI Mode**: Play against an AI opponent who makes random dart throws.
